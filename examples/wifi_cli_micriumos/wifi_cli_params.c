/***************************************************************************//**
 * @file
 * @brief Initialization & registration of the global parameters.
 *        Implementation of parameters' processing callback functions
 *******************************************************************************
 * # License
                                 ...
                                 char *new_value)
{
  ...
  } else if (strstr(param_name, "gateway") == 0) {
      /* Set new gateway to network interface */
      netif_set_gw(netif_ptr, &newIP);

  } else if (strstr(param_name, "ip") == 0) {
